...
async function loadAllDownloadJSONs() {
    ...
    const jsonFiles = [
        ...
        "jsons/downloadjsons/modernity1.7crafting.json",
        "jsons/downloadjsons/modernity1.7fixes.json",
        "jsons/downloadjsons/modernity1.7fun.json",
